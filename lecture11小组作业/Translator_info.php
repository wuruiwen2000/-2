...
<div class="col-sm-60 col-md-60" style="margin:0 auto">
...
echo " <thead class='thead-dark'></thread>";
echo"<th>译者ID</th><th>译者姓名</th><th>操作</th>";
echo"</br>";
while($row=mysqli_fetch_assoc($result)){
echo"<tr><td>{$row['user_id']}</td>";
echo"<td>{$row['user_name']}</td>";
echo"<td><input  type='submit' value='确认添加' /></td>";
echo"</tr>";
}
?>
</div>	
